...
# 🔁 Simple Cache (no UI change)
movie_cache = {}

def make_gemini_api_call(model, contents, config, tools=None, max_retries=3):
...
def recommend():
    ...
    prompt = f"Recommend 3-5 real movies for: {user_input} in JSON."
